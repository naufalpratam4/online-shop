<!-- Main modal -->
<div id="updatePasswordModal-{{ $user->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="updatePasswordModal-{{ $user->id }}">
            ...
            <form action="#">
                <div class="grid gap-4 mb-4 ">
                    <div>
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masukkan Password
                            terkini</label>
