<!-- Main modal -->
<div id="updateJenisKelaminModal-{{ $user->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="updateJenisKelaminModal-{{ $user->id }}">
            ...
            <!-- Modal body -->
            <form action="{{ route('user.edit.jenis_kelamin') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 ">
                    <div>
                        ...
                        <select id="jenis_kelamin" name="jenis_kelamin"
                            ...
                            <option value="Tidak ingin disebutkan">Tidak ingin disebutkan</option>
                        </select>
