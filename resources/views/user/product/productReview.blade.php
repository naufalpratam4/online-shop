        ...
        <div class="mt-6 divide-y divide-gray-200 dark:divide-gray-700">
            <div class="gap-3 pb-6 sm:flex sm:items-start">
                ...
                <div class="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                    <p class="text-base font-normal text-gray-500 dark:text-gray-400">My old IMAC was from 2013. This
        ...
        <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
            ...
            <div
                ...
                <div>
                    ...
                    <a href="#" class="font-medium text-primary-700 hover:underline dark:text-primary-500">Apple
            ...
            <form class="p-4 md:p-5">
                <div class="mb-4 grid grid-cols-2 gap-4">
                    ...
                    <div class="col-span-2">
                        <p class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Add real photos of the
